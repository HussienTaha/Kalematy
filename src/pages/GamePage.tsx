  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-sky-100 to-indigo-100 px-4 py-10 sm:py-12 dark:from-slate-950 dark:to-slate-900">
      <div className="mx-auto max-w-5xl">
        ...
        <PageHeader title="لعبة: اسمع واختر" subtitle="اضغط على الكلمة لسماعها ثم اختر الصورة الصحيحة." />
            ...
            {!round ? (
              ...
              <div className="space-y-5">
                <button
                  ...
                  className="flex w-full items-center justify-between gap-3 rounded-3xl border border-white/30 bg-white/70 px-5 py-4 text-slate-900 shadow-sm transition hover:bg-white focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-indigo-300 dark:border-white/10 dark:bg-slate-900/60 dark:text-slate-100"
                ...
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
                  {round.options.map((option) => {
                    ...
                    const ringClass = isCorrect
                      ? 'ring-4 ring-emerald-400 ring-offset-2 ring-offset-white/60 dark:ring-offset-slate-900/60'
                      : isWrongPicked
                        ? 'ring-4 ring-red-400 ring-offset-2 ring-offset-white/60 dark:ring-offset-slate-900/60'
                        : 'hover:ring-4 hover:ring-indigo-300 hover:ring-offset-2 hover:ring-offset-white/60 dark:hover:ring-offset-slate-900/60'
                    ...
                    return (
                      <button
                        ...
                        className={`group relative aspect-[4/3] w-full overflow-hidden rounded-3xl border border-white/30 bg-white/60 shadow-sm transition focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-indigo-300 dark:border-white/10 dark:bg-slate-900/50 ${ringClass}`}
